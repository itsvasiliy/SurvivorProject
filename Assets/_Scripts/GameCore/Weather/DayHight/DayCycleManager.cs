...
public class DayCycleManager : MonoBehaviour
{
    ...
    private void Update() // В каждом кадре (каждое обновление)
    {
        ...
        float clampedRotationProgress = rotationProgress % 360f; // Прогресс вращения, ограниченный от -360 до 360 градусов

        Quaternion sunRotation = Quaternion.Euler(clampedRotationProgress, 0, 0); // Вращение солнца только вокруг оси X
        Quaternion moonRotation = Quaternion.Euler(clampedRotationProgress + 180f, 0, 0); // Вращение луны только вокруг оси X
